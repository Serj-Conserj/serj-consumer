...
class VoiceBotService:
    ...
    def build_system_prompt(self, booking_info: dict) -> str:
        ...
        return (
            ...
            "Отвечай всегда кратко. Придумывать ничего не надо"
            ...
            f"ВАЖНО! если ты понимаешь, что тебе сказали, что стол смогли успешно забронировать (даже ели кажется фраза немного странной или с ошибками - но ты понимаешь что он говорит что забронировали), то верни дословно {booking_success_state}"
            ...
            "ТАКЖЕ не отвечай цифрами (я про дуты и время) все цифры пиши буквами ТОЛЬКО БУКВЫ!!!!!"
        )
